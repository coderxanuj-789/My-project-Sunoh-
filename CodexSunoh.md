...
Screenshots
-----------
Add one or more screenshots in the `docs/screenshots/` folder and reference them here:

![Now Playing](docs/screenshots/now-playing.svg)
![Playlist](docs/screenshots/playlist.svg)
